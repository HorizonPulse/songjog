CREATE TYPE user_roles AS ENUM ( 'employer',
	'employee',
	'admin'
);
...
CREATE TYPE employer_type AS ENUM ( 'personal',
	'business'
);
...
CREATE TABLE "employee_profiles" (
	"ID" INT PRIMARY KEY,
	"USER_ID" INT,
	"JOB_PREFER_LOCATION" VARCHAR(255),
	"JOB_INTEREST" TEXT,
	"EDUCATION_DEGREE" VARCHAR(255),
	"EDUCATION_INSTITUTION" VARCHAR(255),  -- need different table
	"JOB_EXPERIENCE" TEXT, -- need different table
